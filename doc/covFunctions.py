...
#
# 1) With only the covariance function name (no loghyper, no inputs):
#
#    p = covNAME(None, None)
#
...
# containing the name of the covariance function or using a tuple. For
# example:
#
#   covfunc = 'covRQard'
#   covfunc = ('covRQard',)
#
# are both supported. Only the second form using the tuple can be used
